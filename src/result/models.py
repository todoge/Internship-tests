...
class ResultManager(models.Manager):
    def create_result(self, coin, guess_price, actual_price, author, created_at):
        coin = self.create(coin=coin, guess_price=guess_price, actual_price=actual_price, author=author, created_at=created_at);
        return coin
